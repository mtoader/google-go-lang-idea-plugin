...
public class GoUnusedUnexportedGlobalVariableInspection extends GoUnusedVariableInspection {
  @Override
  ...
  protected boolean shouldValidate(@Nullable GoVarDeclaration varDeclaration, GoCompositeElement varSpec) {
    return !super.shouldValidate(varDeclaration, varSpec) && varSpec != null && !StringUtil.isCapitalized(varSpec.getText());
  }
}
