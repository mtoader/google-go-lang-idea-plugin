...
public class GoHighlightingTest extends GoCodeInsightFixtureTestCase {
  ...
  public void setUp() throws Exception {
    ...
    myFixture.enableInspections(
      ...
      GoUnusedUnexportedVariableInspection.class,
      GoUnusedExportedVariableInspection.class,
      GoUnusedImportInspection.class,
      GoUnusedConstInspection.class,
      GoUnusedUnexportedGlobalVariableInspection.class,
      GoUnusedExportedGlobalVariableInspection.class,
